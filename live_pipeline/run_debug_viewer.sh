#!/usr/bin/env bash
# Runs w_osc_debug_viewer.py with latent_pipeline/.venv's interpreter (needs
...
exec "$REPO_ROOT/latent_pipeline/.venv/bin/python3" "$REPO_ROOT/live_pipeline/w_osc_debug_viewer.py" "$@"
