...
try:
    ...
    client.send_message('/crocodile/control/grid/select', target_id)
    client.send_message('/crocodile/control/transition/duration', 0.01)  # jump immediately for a fast test
    client.send_message('/crocodile/control/transition/running', 1)
    ...
    client.send_message('/crocodile/control/output/truncation', 1.0)
    fake_w_u = [0.0] * W_DIM
    fake_w_u[0] = 42.0
    client.send_message('/crocodile/latent/user', fake_w_u)
    client.send_message('/crocodile/control/mix/amount', 0.0)
    time.sleep(0.5)
    last = received[-1]
