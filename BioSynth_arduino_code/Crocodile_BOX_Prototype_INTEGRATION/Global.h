...
SkinConductance sc1(A2); // create instance for gsr sensor1
SkinConductance sc2(A6); // create instance for gsr sensor2
...
unsigned long writeBuffer[BUFFER_SIZE] = {0}; // Temporary buffer that holds the data while writing to card
