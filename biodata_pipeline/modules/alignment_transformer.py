"""
Cross-subject alignment transformers: map a new subject's biodata features
...
batch) and live (live_pipeline/live_pipeline.py calls load_transformer() once
at startup and .transform() per incoming feature row).
"""
