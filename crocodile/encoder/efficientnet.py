...
@encode.register
def encode_efficientnet_type(obj: EfficientNetType) -> str:
    """ We choose to encode a tensor as a list, for instance """
    return obj.name


def decode_efficientnet_type(name: str) -> EfficientNetType:
    return EfficientNetType[name]


register_decoding_fn(EfficientNetType, decode_efficientnet_type)


@dataclass
class EfficientNetOptions(Serializable):
...
def _efficientnet(
    ...
    **kwargs: Any,
    ...
    model = _EfficientNet(inverted_residual_setting, dropout, **kwargs)
    return model


def efficientnet_b0(**kwargs: Any) -> _EfficientNet:
    """
    ...
    """
    return _efficientnet(1.0, 1.0, 0.2, **kwargs)


def efficientnet_b1(**kwargs: Any) -> _EfficientNet:
    """
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _efficientnet(1.0, 1.1, 0.2, **kwargs)


def efficientnet_b2(**kwargs: Any) -> _EfficientNet:
    """
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _efficientnet(1.1, 1.2, 0.3, **kwargs)


def efficientnet_b3(**kwargs: Any) -> _EfficientNet:
    """
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _efficientnet(1.2, 1.4, 0.3, **kwargs)


def efficientnet_b4(**kwargs: Any) -> _EfficientNet:
    """
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _efficientnet(1.4, 1.8, 0.4, **kwargs)


def efficientnet_b5(**kwargs: Any) -> _EfficientNet:
    """
...
def efficientnet_b6(**kwargs: Any) -> _EfficientNet:
    """
...
def efficientnet_b7(**kwargs: Any) -> _EfficientNet:
    """
