...
from .networks_Discriminator import Discriminator
from .networks_Generator import MappingNetwork, SynthesisNetwork
...
# ----------------------------------------------------------------------------
@dataclass
class StyleGAN2LossConfig:
    augment_pipe: Optional[...] = None
...
class StyleGAN2Loss(Loss):
    def __init__(
        ...
        G_synthesis: SynthesisNetwork,
        D: Discriminator,
        config: StyleGAN2LossConfig = StyleGAN2LossConfig()
        ...
        self.D = D
        self.augment_pipe = config.augment_pipe
        self.style_mixing_prob = config.style_mixing_prob
        self.r1_gamma = config.r1_gamma
        self.pl_batch_shrink = config.pl_batch_shrink
        self.pl_decay = config.pl_decay
        self.pl_weight = config.augment_pipepl_weight
