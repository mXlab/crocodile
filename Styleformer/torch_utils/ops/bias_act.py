...
import numpy as np
import torch
from Styleformer import dnnlib
import traceback
...
def _bias_act_cuda(
    ...
    class BiasActCuda(torch.autograd.Function):
        @staticmethod
        def forward(
            ctx, x: torch.Tensor, b: torch.Tensor
        ...
        @staticmethod
        def backward(ctx, dy: torch.Tensor):  # pylint: disable=arguments-differ
    ...
    class BiasActCudaGrad(torch.autograd.Function):
        @staticmethod
        def forward(ctx, dy: torch.Tensor, x: torch.Tensor, b: torch.Tensor, y: torch.Tensor):  # pylint: disable=arguments-differ
            ctx.memory_format = (
                torch.channels_last
        ...
        @staticmethod
        def backward(ctx, d_dx: torch.Tensor):  # pylint: disable=arguments-differ
